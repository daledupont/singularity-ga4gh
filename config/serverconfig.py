...
class BaseConfig(object):
    ...
    ROOT = "/srv/ga4gh-server/ga4gh/server"
    INITIAL_PEERS = ROOT + "/templates/initial_peers.txt"
...
class TestAuth0Config(DevelopmentConfig):
    ...
    AUTH0_CLIENT_SECRET = "KeV2tMyGaSgLeOhpoGs_XLH65Tfw43yB\
                           jT8DIpaTxXAKmd_bguJwXA6T7D0iYfgB"
...
class TestOidcConfig(TestConfig):
    ...
    OIDC_CLIENT_ID = "demo"
    OIDC_CLIENT_SECRET = "xxx"
    BASE_URL = "http://localhost:8080/auth/realms/demo/protocol"
    OIDC_AUTHZ_ENDPOINT = BASE_URL + "/openid-connect/auth"
    OIDC_TOKEN_ENDPOINT = BASE_URL + "/openid-connect/token"
    OIDC_TOKEN_REV_ENDPOINT = BASE_URL + "/openid-connect/token/introspect"
